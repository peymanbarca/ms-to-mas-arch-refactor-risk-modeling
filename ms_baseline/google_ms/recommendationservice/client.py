...
logger = logging.getLogger("recommendationservice-client")

_DEFAULT_ADDR = os.getenv("RECOMMENDATION_SERVICE_ADDR", "localhost:8080")
...
class RecommendationClient:
    """
    Async gRPC client for RecommendationService (port 8080).
...
if __name__ == "__main__":
    ...
    Examples:
        ...
        RECOMMENDATION_SERVICE_ADDR=recs:8080 python -m recommendationservice.client u1
    """
    if len(sys.argv) < 2:
