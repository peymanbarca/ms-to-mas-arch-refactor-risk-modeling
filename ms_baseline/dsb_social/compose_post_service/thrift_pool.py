...
Used here for all five downstream Thrift service clients:
  UniqueIdService, MediaService, TextService, UserService,
  PostStorageService, UserTimelineService.
"""
...
logger = logging.getLogger("compose-post-service.pool")
