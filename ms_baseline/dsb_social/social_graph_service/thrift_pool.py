...
Identical to the pool used in text-service. Reused here for the
downstream UserService client (needed by FollowWithUsername / UnfollowWithUsername).
"""
...
logger = logging.getLogger("social-graph-service.pool")
