...
c_cyc = [["pricing_service:8003", 10],
           ["product_catalog_service:8008", 12],
           ["inventory_service:8001", 10],
           ["shopping_cart_service:8003", 12],
           ["payment_service:8007", 14], 
           ["order_service:8000", 15],
           ["subscription_service:8010", 12],
           ["procurement_service:8009", 18],
           ["shipment_service:8006", 14], 
...
c_cog = [["pricing_service:8003", 8],
           ["product_catalog_service:8008", 11],
           ["inventory_service:8001", 16],
           ["shopping_cart_service:8003", 9],
           ["payment_service:8007", 10], 
           ["order_service:8000", 28],
           ["subscription_service:8010", 10],
           ["procurement_service:8009", 12],
           ["shipment_service:8006", 20], 
...
def init_conditions():
    ...
    return migration_sorting_strategy_services, previous_step_acceptance_types, temporal_propagations
                ...
                for T_ in T:
                    for CONCURRENCY_RATE_ in CONCURRENCY_RATE:
                        ...
                        try:
                            ...
                            current_agents = []
                            migration_sorting_strategy_services, previous_step_acceptance_types, temporal_propagations = init_conditions()
