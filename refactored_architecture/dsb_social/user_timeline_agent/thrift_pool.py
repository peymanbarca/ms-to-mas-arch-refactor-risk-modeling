...
Identical pattern used across text-service, social-graph-service, etc.
Used here for the downstream PostStorageService client pool.
"""
...
logger = logging.getLogger("user-timeline-service.pool")
